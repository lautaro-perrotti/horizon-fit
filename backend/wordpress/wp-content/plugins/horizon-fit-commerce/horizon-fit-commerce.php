...
require_once HF_COMMERCE_DIR . 'includes/page-builder.php';
require_once HF_COMMERCE_DIR . 'includes/generator.php';
require_once HF_COMMERCE_DIR . 'includes/admin-page.php';
